...
export default function Page() {
  ...
  return (
    <div className="relative w-full max-w-sm">
      ...
      <div 
        className={`absolute bottom-0 left-0 right-0 h-4/5 bg-white shadow-xl rounded-t-xl transition-all duration-500 ease-in-out ${
          showDetails 
...
<div className="flex gap-3">
  ...
  <div className="flex flex-col max-w-[90%]">
    ...
    <div className="mt-3 bg-white rounded-lg border border-gray-200 p-3">
      <div className="text-xs font-medium mb-3">Price Comparison</div>
      <div className="relative h-48">
        ...
        <div className="absolute left-10 right-2 bottom-6 top-0 flex items-end justify-around">
          <div className="flex flex-col items-center">
            <div className="w-14 bg-gradient-to-t from-amber-500 to-amber-300 rounded-t-md shadow-sm" style={{height: "40%"}}>
              <div className="text-xs text-center font-medium text-white py-1">$19.99</div>
            </div>
            <div className="mt-2 text-xs font-medium bg-amber-100 px-2 py-1 rounded-full">This Product</div>
          </div>
          
          <div className="flex flex-col items-center">
            <div className="w-14 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-md shadow-sm" style={{height: "60%"}}>
              <div className="text-xs text-center font-medium text-white py-1">$29.99</div>
            </div>
            <div className="mt-2 text-xs bg-gray-100 px-2 py-1 rounded-full">Basic Mount</div>
          </div>
          
          <div className="flex flex-col items-center">
            <div className="w-14 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-md shadow-sm" style={{height: "80%"}}>
              <div className="text-xs text-center font-medium text-white py-1">$39.99</div>
            </div>
            <div className="mt-2 text-xs bg-gray-100 px-2 py-1 rounded-full">Premium</div>
          </div>
          
          <div className="flex flex-col items-center">
            <div className="w-14 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t-md shadow-sm" style={{height: "95%"}}>
              <div className="text-xs text-center font-medium text-white py-1">$49.99</div>
            </div>
            <div className="mt-2 text-xs bg-gray-100 px-2 py-1 rounded-full">Pro Model</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="mt-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 shadow-sm">
        ...
        <div className="p-3 bg-gradient-to-br from-red-50 to-red-100 rounded-lg border border-red-200 shadow-sm">
